            ...
            <div className="w-full max-w-7xl mx-auto p-4 md:p-8 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <button
                        ...
                        className={`p-6 rounded-2xl border transition-all duration-300 text-left relative overflow-hidden group ${assessmentType === 'aptitude'
                    ...
                    >
                        <div className="flex justify-between items-start mb-4">
                            <div className="space-y-1">
                                <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Assessment Type</p>
                                <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Aptitude</h3>
                            </div>
                            <div className={`p-3 rounded-xl ${assessmentType === 'aptitude' ? 'bg-blue-500 text-white' : 'bg-blue-100 text-blue-500 dark:bg-blue-800 dark:text-blue-200'}`}>
                        ...
                        <div className="flex items-center gap-2">
                            <span className={`text-sm ${assessmentType === 'aptitude' ? 'text-blue-600 dark:text-blue-400 font-medium' : 'text-green-600 dark:text-green-400'}`}>
                                {assessmentType === 'aptitude' ? 'Selected' : 'Click to select'}
                            </span>
                        </div>
                    </button>
                    ...
                    <button
                        ...
                        className={`p-6 rounded-2xl border transition-all duration-300 text-left relative overflow-hidden group ${assessmentType === 'soft_skills'
                    ...
                    >
                        <div className="flex justify-between items-start mb-4">
                            ...
                            <div className={`p-3 rounded-xl ${assessmentType === 'soft_skills' ? 'bg-purple-500 text-white' : 'bg-purple-100 text-purple-500 dark:bg-purple-800 dark:text-purple-200'}`}>
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div className="flex items-center gap-2">
                            <span className={`text-sm ${assessmentType === 'soft_skills' ? 'text-purple-600 dark:text-purple-400 font-medium' : 'text-gray-500 dark:text-gray-400'}`}>
                                {assessmentType === 'soft_skills' ? 'Selected' : 'Click to select'}
                            </span>
                        </div>
                    </button>
                    ...
                    <div className="p-6 rounded-2xl border border-gray-100 dark:border-gray-700 bg-[#FFF9E6] dark:bg-yellow-900/30 relative overflow-hidden">
                        <div className="flex justify-between items-start mb-4">
                            <div className="space-y-1">
                                ...
                                <h3 className="text-2xl font-bold text-gray-900 dark:text-white">{numQuestions}</h3>
                            </div>
                        ...
                        <div className="flex items-center gap-2">
                            <span className="text-sm text-yellow-700 dark:text-yellow-400 font-medium">~{Math.round(numQuestions * 1.5)} mins</span>
                                ...
                                <input
                                    ...
                                    placeholder={
                                        assessmentType === 'aptitude'
                                            ? "e.g., 'work and time', 'percentages'..."
                                            : "e.g., 'communication', 'leadership'..."
                                    }
                                    className="w-full pl-11 pr-4 py-4 border-2 border-gray-100 dark:border-gray-700 rounded-xl focus:border-blue-500 focus:ring-blue-500 transition-all bg-gray-50/50 dark:bg-gray-700/50 dark:text-white dark:placeholder-gray-500"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
                            ...
                            <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl flex items-center justify-between">
                                ...
                                <span className="text-2xl font-bold text-gray-900 dark:text-white">{numQuestions}</span>
                            </div>
                        </div>
