...
export default function ResumePage() {
  ...
  return (
    <DashboardLayout requiredUserType="student">
      <div className="space-y-4 px-2 sm:px-3 pb-8 w-full max-w-[98%] mx-auto">
        {/* Premium Hero Banner */}
        {currentStep === 1 && (
          <div className="bg-gradient-to-r from-blue-100/80 via-indigo-100/60 to-purple-100/70 dark:from-blue-950/60 dark:via-indigo-950/40 dark:to-purple-950/50 border border-blue-200 dark:border-blue-900/50 rounded-2xl shadow-sm p-4 sm:p-6 md:p-8 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-6 overflow-hidden relative">
            ...
            <div className="space-y-1.5 sm:space-y-3 max-w-2xl z-10 w-full">
              <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-950/40 px-2 py-0.5 sm:py-1 rounded-md inline-block">
                Resume Analysis
              </span>
              <h1 className="text-lg sm:text-2xl md:text-4xl font-extrabold text-gray-950 dark:text-gray-50 tracking-tight leading-tight">
                Let's{" "}
              ...
              <p className="text-gray-600 dark:text-gray-300 text-[11px] sm:text-sm md:text-base leading-relaxed">
            ...
            {/* Hero illustration */}
            <div className="w-full md:w-72 lg:w-96 flex-shrink-0 z-10 flex justify-center">
              <img
                src="/images/heropage-ats.png"
                alt="Resume ATS Scan Illustration"
                className="max-h-24 sm:max-h-36 md:max-h-40 object-contain drop-shadow-none"
              />
            </div>
          </div>
        )}
        ...
        {/* <div className="w-full bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-none p-4 sm:p-5 shadow-none-none">
        ...
        {currentStep === 1 && (
          <div className="space-y-4 w-full">
            <Card className="border border-gray-200 dark:border-gray-700 shadow-sm rounded-xl overflow-hidden bg-white dark:bg-gray-900">
              ...
              <CardContent className="pt-6 space-y-4">
                ...
                {(!file || isUploading) && (
                  ...
                  >
                    ...
                    <div className="space-y-3 relative z-10">
                      <div className="w-10 h-10 bg-indigo-50 dark:bg-indigo-950/30 rounded-full flex items-center justify-center mx-auto text-indigo-600 group-hover:scale-110 transition-transform duration-300">
                      ...
                      {/* Compact Choose File button */}
                      <Button
                        type="button"
                        className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-8 py-2.5 text-xs sm:text-sm rounded-lg shadow-sm transition-all duration-300"
                      >
                        Choose File
                      </Button>
                ...
                {error && (
                  <Alert
                    variant="destructive"
                    className="rounded-lg border-rose-200 bg-rose-50/50 dark:bg-rose-950/10"
                  >
                ...
                {/* Selected File Card */}
                {file && (
                  <div className="flex items-center justify-between p-3.5 bg-gray-50 dark:bg-gray-800/40 border border-gray-200 dark:border-gray-800 rounded-lg shadow-sm">
                    <div className="flex items-center gap-3 min-w-0">
                      <div className="w-10 h-10 bg-indigo-50 dark:bg-indigo-950/30 rounded-lg flex items-center justify-center text-indigo-600 flex-shrink-0">
                ...
                {file && !uploadSuccess && (
                  <Button
                    ...
                    disabled={isUploading}
                    className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-5 rounded-lg shadow-sm transition-all duration-300"
                  >
                    {isUploading
                ...
                {/* Checkbox for Target Job Description */}
                {(resumeStatus?.has_resume || uploadSuccess) && (
                  <div className="flex justify-end items-center gap-2.5 pt-3 pb-1 border-t border-gray-200 dark:border-gray-700">
                    <input
                      type="checkbox"
                      id="target-job-desc-toggle"
                      checked={showJobDescriptionInput}
                      onChange={(e) =>
                        setShowJobDescriptionInput(e.target.checked)
                      }
                    ...
                    >
                      I want to analyze my resume against a specific job
                      description
                    </label>
                  </div>
                )}

                {/* 1st Analyze button (Visible only if checkbox is unchecked) */}
                {(resumeStatus?.has_resume || uploadSuccess) &&
                  !showJobDescriptionInput && (
                    <Button
                      onClick={handleCalculateATS}
                      disabled={isCalculatingATS}
                      className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-5 rounded-lg shadow-sm transition-all duration-300 flex items-center justify-center gap-2"
                    >
                ...
                {/* Job Description Card & 2nd Analyze Button (Visible only if checkbox is checked) */}
                {(resumeStatus?.has_resume || uploadSuccess) &&
                  showJobDescriptionInput && (
                    <Card className="border border-gray-200 dark:border-gray-700 shadow-sm bg-gradient-to-br from-white to-indigo-50/20 dark:from-gray-900 dark:to-indigo-950/5 rounded-xl overflow-hidden mt-2">
                      <CardHeader className="pb-3 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <CardDescription className="text-xs">
                          Paste the job description to align your resume
                          analysis with target recruiters.
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="pt-4 space-y-4">
                        <Textarea
                          ...
                          rows={4}
                          disabled={isCalculatingATS}
                          className="border-gray-200 dark:border-gray-800 rounded-lg resize-none text-sm focus:border-indigo-400 focus:ring-indigo-200"
                        />
                        <Button
                          onClick={handleCalculateATS}
                          disabled={isCalculatingATS}
            ...
            {/* Separated Active Stored Resume Card (above the Tip banner) */}
            {resumeStatus?.has_resume && !file && (
              <div className="flex items-center justify-between p-3.5 bg-emerald-50/30 dark:bg-emerald-950/10 border border-emerald-200 dark:border-emerald-800 rounded-xl shadow-sm">
                <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="text-xs font-semibold text-emerald-700 dark:text-emerald-400 px-2 py-1 bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-100 dark:border-emerald-900/30">
        ...
        {currentStep === 4 && report && (
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <Card className="lg:col-span-4 border border-gray-200 dark:border-gray-800 rounded-xl shadow-sm bg-white dark:bg-gray-900 flex flex-col justify-between overflow-hidden">
              ...
              <Card className="lg:col-span-8 border border-gray-200 dark:border-gray-800 rounded-xl shadow-sm bg-white dark:bg-gray-900 flex flex-col justify-between overflow-hidden">
                <CardHeader className="pb-2 border-b border-gray-150 dark:border-gray-800">
                  <CardTitle className="text-sm font-bold text-gray-700 dark:text-gray-300">
                    Score Breakdown
                  </CardTitle>
                    ...
                    >
                      <div className="relative w-16 h-16 sm:w-20 sm:h-20 flex items-center justify-center">
                        <svg
                          className="w-full h-full transform -rotate-90"
                          viewBox="0 0 36 36"
                          aria-label={`${c.name} score radial gauge`}
                        >
                          <circle
                            cx="18"
                            cy="18"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <Card className="lg:col-span-8 border border-gray-200 dark:border-gray-800 rounded-xl shadow-sm bg-white dark:bg-gray-900 overflow-hidden">
              ...
              <Card className="lg:col-span-4 border border-gray-200 dark:border-gray-800 rounded-xl shadow-sm bg-white dark:bg-gray-900 overflow-hidden">
                <CardHeader className="pb-3 border-b border-gray-50 dark:border-gray-800">
                  <CardTitle className="text-base font-bold text-gray-900 dark:text-gray-100">
                    Top Recommendations
                  </CardTitle>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <Card className="lg:col-span-6 border border-gray-200 dark:border-gray-800 rounded-xl shadow-sm bg-white dark:bg-gray-900 overflow-hidden">
                <CardHeader className="pb-3 border-b border-gray-50 dark:border-gray-800">
                  <CardTitle className="text-base font-bold text-gray-900 dark:text-gray-100">
                    Section Analysis
                  </CardTitle>
            ...
            <Card className="border border-indigo-700/50 dark:border-indigo-800 bg-indigo-600 dark:bg-indigo-900 text-white rounded-xl shadow-md overflow-hidden">
