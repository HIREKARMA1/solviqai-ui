        ...
        <DashboardLayout requiredUserType="student">
            <div className="space-y-6">
                ...
                {loading ? (
                    ...
                    <>
                        {/* Career Guidance Featured Card */}
                        <Link href="/dashboard/student/career-guidance">
                            <motion.div
                                className="relative overflow-hidden rounded-2xl p-8 bg-gradient-to-br from-cyan-500 via-blue-500 to-indigo-600 text-white cursor-pointer group"
                                ...
                                <div className="relative z-10 flex items-center justify-between">
                                    <div className="flex-1">
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <div>
                                                <h2 className="text-2xl md:text-3xl font-bold">AI Career Guidance</h2>
                                                <p className="text-cyan-100 text-sm">Discover your perfect career path</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-center gap-4">
                                            <Button 
                                                variant="secondary"
                                                className="bg-white text-blue-600 hover:bg-blue-50 font-semibold group-hover:shadow-lg transition-all"
                                            >
                                    ...
                                    >
                                        <div className="relative">
                                            ...
                                            <Target className="relative h-32 w-32 text-white/30" />
                                        </div>
                                    </motion.div>
                                </div>
                            </motion.div>
